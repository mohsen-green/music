            ...
            <div class="card-box">
                ...
                <form action="{{url('artist')}}" enctype="multipart/form-data" method="post" multiple="">
                   ...
                   <input name="artist_id" value="{{ isset($artists->_id) ? $artists->_id : ''}}" type="hidden">
                    <div class="d-flex">
                        <div class="form-group mb-3 mr-3" style="flex: 1">
                            ...
                            <input class="form-control" id="product-name" name="name" placeholder="" type="text" value="{{ isset($artists) ? $artists->name : '' }}">
                            </input>
                        </div>
                  ...
                  @lang('form.artist_des')
                            ...
                            <input class="form-control" name="des" placeholder=""  value="{{ isset($artists) ? $artists->des : '' }}"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
