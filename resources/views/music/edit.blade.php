    ...
    @endif
        <div class="row">
            <div class="col-12">
                          ...
                          <form action="{{ url('music/'.$music->_id) }}" enctype="multipart/form-data" method="post" multipart="">
    ...
    {{-- fild2 --}}
                        <div class="d-flex">
                            <div class="form-group mb-3 mr-3 " style="flex:1">
                                ...
                                <input class="form-control" id="product-name" name="musicfile" placeholder="" type="file">
                                </input>
                            </div>
                            <div class="form-group mb-3" style="flex: 1">
                                <label for="product-name">
