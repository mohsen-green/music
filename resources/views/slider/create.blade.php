...
<form action="{{ url('slider/') }}" method="POST" enctype="multipart/form-data" class="">
    ...
    <div class="d-flex mt-2">
        <div class="d-flex flex-column mr-3" style="width: 50%">
            ...
            <input type="text" class="form-control mr-3 disabled border-1" readonly placeholder="انتخاب موزیک" value="انتخاب البوم">
        </div>
        <div class="d-flex flex-column " style="width: 50%">
    ...
    <div class="d-flex mt-2">
        <div class="d-flex flex-column mr-3" style="width: 50%">
            ...
            <input type="text" class="form-control mr-3 disabled border-1" readonly placeholder="انتخاب البوم" value="انتخاب البوم">
        </div>
        <div class="d-flex flex-column " style="width: 50%">
    ...
    <div class="d-flex mt-2">
        <div class="d-flex flex-column mr-3" style="width: 50%">
            ...
            <input type="text" class="form-control mr-3 disabled border-1 " readonly placeholder="انتخاب هنرمند" value="انتخاب هنرمند">
        </div>
        <div class="d-flex flex-column " style="width: 50%">
    ...
    <div class="d-flex mt-2">
        <div class="d-flex flex-column mr-3  " style="width: 50%">
            ...
            <input type="text" class="form-control mr-3 disabled border-1 " readonly placeholder=" ساخت لینک   " value="ساخت لینک" >
        </div>
        <div class="d-flex flex-column " style="width: 50%">

            <input type="text" name="link" class="form-control mr-3" value="">
